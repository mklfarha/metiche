...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListInstruction", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListInstruction", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Instruction) any
		...
		var items []repogen.Instruction
		for rows.Next() {
			var i repogen.Instruction
		...
		return types.ListResponse{
			Instruction: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Instruction) any{
	...
	"id": func(i *repogen.Instruction) any { return &i.ID },

	"team_uuid": func(i *repogen.Instruction) any { return &i.TeamUUID },

	"target_session_uuid": func(i *repogen.Instruction) any { return &i.TargetSessionUUID },

	"target_agent_uuid": func(i *repogen.Instruction) any { return &i.TargetAgentUUID },

	"key": func(i *repogen.Instruction) any { return &i.Key },

	"source": func(i *repogen.Instruction) any { return &i.Source },

	"kind": func(i *repogen.Instruction) any { return &i.Kind },

	"body": func(i *repogen.Instruction) any { return &i.Body },

	"ref_kind": func(i *repogen.Instruction) any { return &i.RefKind },

	"ref_uuid": func(i *repogen.Instruction) any { return &i.RefUUID },

	"requires_report": func(i *repogen.Instruction) any { return &i.RequiresReport },

	"status": func(i *repogen.Instruction) any { return &i.Status },

	"raised_by_member_uuid": func(i *repogen.Instruction) any { return &i.RaisedByMemberUUID },

	"delivered_at": func(i *repogen.Instruction) any { return &i.DeliveredAt },

	"acted_at": func(i *repogen.Instruction) any { return &i.ActedAt },

	"action": func(i *repogen.Instruction) any { return &i.Action },

	"action_note": func(i *repogen.Instruction) any { return &i.ActionNote },

	"expires_at": func(i *repogen.Instruction) any { return &i.ExpiresAt },
