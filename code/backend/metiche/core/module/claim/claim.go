...
type Module interface {
	FetchClaimByID(ctx context.Context, req types.FetchClaimByIDRequest, opts ...Option) (types.FetchClaimByIDResponse, error)
	FetchClaimByTeamUUIDAndKey(ctx context.Context, req types.FetchClaimByTeamUUIDAndKeyRequest, opts ...Option) (types.FetchClaimByTeamUUIDAndKeyResponse, error)
	FetchClaimByProjectUUIDAndStatus(ctx context.Context, req types.FetchClaimByProjectUUIDAndStatusRequest, opts ...Option) (types.FetchClaimByProjectUUIDAndStatusResponse, error)
