...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListClaim", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListClaim", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Claim) any
		...
		return types.ListResponse{
			Claim:       mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Claim) any{

	"id": func(i *repogen.Claim) any { return &i.ID },

	"team_uuid": func(i *repogen.Claim) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.Claim) any { return &i.ProjectUUID },

	"session_uuid": func(i *repogen.Claim) any { return &i.SessionUUID },

	"member_uuid": func(i *repogen.Claim) any { return &i.MemberUUID },

	"intent_uuid": func(i *repogen.Claim) any { return &i.IntentUUID },

	"key": func(i *repogen.Claim) any { return &i.Key },

	"mode": func(i *repogen.Claim) any { return &i.Mode },

	"status": func(i *repogen.Claim) any { return &i.Status },

	"ttl_seconds": func(i *repogen.Claim) any { return &i.TtlSeconds },

	"expires_at": func(i *repogen.Claim) any { return &i.ExpiresAt },

	"hard_expires_at": func(i *repogen.Claim) any { return &i.HardExpiresAt },

	"breadth_score": func(i *repogen.Claim) any { return &i.BreadthScore },

	"released_at": func(i *repogen.Claim) any { return &i.ReleasedAt },

	"release_reason": func(i *repogen.Claim) any { return &i.ReleaseReason },

	"created_at": func(i *repogen.Claim) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Claim) any { return &i.UpdatedAt },
}
