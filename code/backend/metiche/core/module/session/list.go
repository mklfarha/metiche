...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListSession", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListSession", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Session) any
		...
		var items []repogen.Session
		for rows.Next() {
			var i repogen.Session
		...
		return types.ListResponse{
			Session:     mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Session) any{
	...
	"id": func(i *repogen.Session) any { return &i.ID },

	"team_uuid": func(i *repogen.Session) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.Session) any { return &i.ProjectUUID },

	"agent_uuid": func(i *repogen.Session) any { return &i.AgentUUID },

	"member_uuid": func(i *repogen.Session) any { return &i.MemberUUID },

	"key": func(i *repogen.Session) any { return &i.Key },

	"branch": func(i *repogen.Session) any { return &i.Branch },

	"base_commit": func(i *repogen.Session) any { return &i.BaseCommit },

	"head_commit": func(i *repogen.Session) any { return &i.HeadCommit },

	"goal": func(i *repogen.Session) any { return &i.Goal },

	"status": func(i *repogen.Session) any { return &i.Status },

	"status_line": func(i *repogen.Session) any { return &i.StatusLine },

	"current_intent_uuid": func(i *repogen.Session) any { return &i.CurrentIntentUUID },

	"started_at": func(i *repogen.Session) any { return &i.StartedAt },

	"last_heartbeat_at": func(i *repogen.Session) any { return &i.LastHeartbeatAt },

	"ended_at": func(i *repogen.Session) any { return &i.EndedAt },

	"outcome": func(i *repogen.Session) any { return &i.Outcome },

	"outcome_note": func(i *repogen.Session) any { return &i.OutcomeNote },
