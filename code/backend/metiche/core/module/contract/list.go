...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListContract", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListContract", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Contract) any
		...
		var items []repogen.Contract
		for rows.Next() {
			var i repogen.Contract
		...
		return types.ListResponse{
			Contract:    mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Contract) any{

	"id": func(i *repogen.Contract) any { return &i.ID },

	"team_uuid": func(i *repogen.Contract) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.Contract) any { return &i.ProjectUUID },

	"key": func(i *repogen.Contract) any { return &i.Key },

	"key_norm": func(i *repogen.Contract) any { return &i.KeyNorm },

	"kind": func(i *repogen.Contract) any { return &i.Kind },

	"status": func(i *repogen.Contract) any { return &i.Status },

	"title": func(i *repogen.Contract) any { return &i.Title },

	"notes": func(i *repogen.Contract) any { return &i.Notes },

	"created_at": func(i *repogen.Contract) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Contract) any { return &i.UpdatedAt },
}
