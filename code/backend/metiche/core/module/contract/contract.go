...
type Module interface {
	FetchContractByID(ctx context.Context, req types.FetchContractByIDRequest, opts ...Option) (types.FetchContractByIDResponse, error)
	FetchContractByProjectUUIDAndKeyNorm(ctx context.Context, req types.FetchContractByProjectUUIDAndKeyNormRequest, opts ...Option) (types.FetchContractByProjectUUIDAndKeyNormResponse, error)
