...
type Module interface {
	FetchPlanByID(ctx context.Context, req types.FetchPlanByIDRequest, opts ...Option) (types.FetchPlanByIDResponse, error)
	FetchPlanByIsInstanceDefaultAndStatus(ctx context.Context, req types.FetchPlanByIsInstanceDefaultAndStatusRequest, opts ...Option) (types.FetchPlanByIsInstanceDefaultAndStatusResponse, error)
	FetchPlanByKey(ctx context.Context, req types.FetchPlanByKeyRequest, opts ...Option) (types.FetchPlanByKeyResponse, error)
