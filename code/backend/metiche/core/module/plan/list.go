...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListPlan", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListPlan", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Plan) any
		...
		return types.ListResponse{
			Plan:        mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Plan) any{

	"id": func(i *repogen.Plan) any { return &i.ID },

	"key": func(i *repogen.Plan) any { return &i.Key },

	"name": func(i *repogen.Plan) any { return &i.Name },

	"description": func(i *repogen.Plan) any { return &i.Description },

	"max_concurrent_agents": func(i *repogen.Plan) any { return &i.MaxConcurrentAgents },

	"retention_days": func(i *repogen.Plan) any { return &i.RetentionDays },

	"max_members": func(i *repogen.Plan) any { return &i.MaxMembers },

	"max_projects": func(i *repogen.Plan) any { return &i.MaxProjects },

	"is_instance_default": func(i *repogen.Plan) any { return &i.IsInstanceDefault },

	"sort_order": func(i *repogen.Plan) any { return &i.SortOrder },

	"status": func(i *repogen.Plan) any { return &i.Status },

	"created_at": func(i *repogen.Plan) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Plan) any { return &i.UpdatedAt },
}
