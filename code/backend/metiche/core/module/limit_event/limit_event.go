...
type Module interface {
	FetchLimitEventByID(ctx context.Context, req types.FetchLimitEventByIDRequest, opts ...Option) (types.FetchLimitEventByIDResponse, error)
	FetchLimitEventByTeamUUIDAndDimension(ctx context.Context, req types.FetchLimitEventByTeamUUIDAndDimensionRequest, opts ...Option) (types.FetchLimitEventByTeamUUIDAndDimensionResponse, error)
