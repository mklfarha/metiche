...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListLimitEvent", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListLimitEvent", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.LimitEvent) any
		...
		var items []repogen.LimitEvent
		for rows.Next() {
			var i repogen.LimitEvent
		...
		return types.ListResponse{
			LimitEvent:  mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.LimitEvent) any{

	"id": func(i *repogen.LimitEvent) any { return &i.ID },

	"team_uuid": func(i *repogen.LimitEvent) any { return &i.TeamUUID },

	"plan_uuid": func(i *repogen.LimitEvent) any { return &i.PlanUUID },

	"session_uuid": func(i *repogen.LimitEvent) any { return &i.SessionUUID },

	"dimension": func(i *repogen.LimitEvent) any { return &i.Dimension },

	"observed": func(i *repogen.LimitEvent) any { return &i.Observed },

	"allowed": func(i *repogen.LimitEvent) any { return &i.Allowed },

	"outcome": func(i *repogen.LimitEvent) any { return &i.Outcome },

	"note": func(i *repogen.LimitEvent) any { return &i.Note },

	"occurred_at": func(i *repogen.LimitEvent) any { return &i.OccurredAt },

	"created_at": func(i *repogen.LimitEvent) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.LimitEvent) any { return &i.UpdatedAt },
}
