...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListInvite", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListInvite", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Invite) any
		...
		var items []repogen.Invite
		for rows.Next() {
			var i repogen.Invite
		...
		return types.ListResponse{
			Invite:      mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Invite) any{

	"id": func(i *repogen.Invite) any { return &i.ID },

	"team_uuid": func(i *repogen.Invite) any { return &i.TeamUUID },

	"code": func(i *repogen.Invite) any { return &i.Code },

	"label": func(i *repogen.Invite) any { return &i.Label },

	"created_by_member_uuid": func(i *repogen.Invite) any { return &i.CreatedByMemberUUID },

	"max_uses": func(i *repogen.Invite) any { return &i.MaxUses },

	"uses": func(i *repogen.Invite) any { return &i.Uses },

	"expires_at": func(i *repogen.Invite) any { return &i.ExpiresAt },

	"revoked_at": func(i *repogen.Invite) any { return &i.RevokedAt },

	"revoked_by_member_uuid": func(i *repogen.Invite) any { return &i.RevokedByMemberUUID },

	"status": func(i *repogen.Invite) any { return &i.Status },

	"last_used_at": func(i *repogen.Invite) any { return &i.LastUsedAt },

	"created_at": func(i *repogen.Invite) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Invite) any { return &i.UpdatedAt },
}
