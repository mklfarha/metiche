...
type Module interface {
	FetchInviteByID(ctx context.Context, req types.FetchInviteByIDRequest, opts ...Option) (types.FetchInviteByIDResponse, error)
	FetchInviteByTeamUUIDAndStatus(ctx context.Context, req types.FetchInviteByTeamUUIDAndStatusRequest, opts ...Option) (types.FetchInviteByTeamUUIDAndStatusResponse, error)
	FetchInviteByCode(ctx context.Context, req types.FetchInviteByCodeRequest, opts ...Option) (types.FetchInviteByCodeResponse, error)
