...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListTeamEvent", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListTeamEvent", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.TeamEvent) any
		...
		var items []repogen.TeamEvent
		for rows.Next() {
			var i repogen.TeamEvent
		...
		return types.ListResponse{
			TeamEvent:   mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.TeamEvent) any{

	"id": func(i *repogen.TeamEvent) any { return &i.ID },

	"team_uuid": func(i *repogen.TeamEvent) any { return &i.TeamUUID },

	"sequence": func(i *repogen.TeamEvent) any { return &i.Sequence },

	"project_uuid": func(i *repogen.TeamEvent) any { return &i.ProjectUUID },

	"session_uuid": func(i *repogen.TeamEvent) any { return &i.SessionUUID },

	"agent_uuid": func(i *repogen.TeamEvent) any { return &i.AgentUUID },

	"member_uuid": func(i *repogen.TeamEvent) any { return &i.MemberUUID },

	"kind": func(i *repogen.TeamEvent) any { return &i.Kind },

	"subject_kind": func(i *repogen.TeamEvent) any { return &i.SubjectKind },

	"subject_uuid": func(i *repogen.TeamEvent) any { return &i.SubjectUUID },

	"subject_key": func(i *repogen.TeamEvent) any { return &i.SubjectKey },

	"structural": func(i *repogen.TeamEvent) any { return &i.Structural },

	"summary": func(i *repogen.TeamEvent) any { return &i.Summary },

	"payload": func(i *repogen.TeamEvent) any { return &i.Payload },

	"idempotency_key": func(i *repogen.TeamEvent) any { return &i.IdempotencyKey },

	"response_snapshot": func(i *repogen.TeamEvent) any { return &i.ResponseSnapshot },

	"occurred_at": func(i *repogen.TeamEvent) any { return &i.OccurredAt },

	"created_at": func(i *repogen.TeamEvent) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.TeamEvent) any { return &i.UpdatedAt },
}
