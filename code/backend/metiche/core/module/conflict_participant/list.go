...
func (m *module) List(ctx context.Context,
	...
	query, args, err := m.repository.BuildListEntityQuery(
		ctx,
		reqPlusOne,
		main_entity.ConflictParticipant{},
		false)
	if err != nil {
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListConflictParticipant", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListConflictParticipant", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.ConflictParticipant) any
		...
		var items []repogen.ConflictParticipant
		for rows.Next() {
			var i repogen.ConflictParticipant
		...
		return types.ListResponse{
			ConflictParticipant: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.ConflictParticipant) any{

	"id": func(i *repogen.ConflictParticipant) any { return &i.ID },

	"conflict_uuid": func(i *repogen.ConflictParticipant) any { return &i.ConflictUUID },

	"team_uuid": func(i *repogen.ConflictParticipant) any { return &i.TeamUUID },

	"session_uuid": func(i *repogen.ConflictParticipant) any { return &i.SessionUUID },

	"agent_uuid": func(i *repogen.ConflictParticipant) any { return &i.AgentUUID },

	"member_uuid": func(i *repogen.ConflictParticipant) any { return &i.MemberUUID },

	"subject_kind": func(i *repogen.ConflictParticipant) any { return &i.SubjectKind },

	"subject_uuid": func(i *repogen.ConflictParticipant) any { return &i.SubjectUUID },

	"role": func(i *repogen.ConflictParticipant) any { return &i.Role },

	"notified_at": func(i *repogen.ConflictParticipant) any { return &i.NotifiedAt },

	"acked_at": func(i *repogen.ConflictParticipant) any { return &i.AckedAt },

	"response": func(i *repogen.ConflictParticipant) any { return &i.Response },

	"created_at": func(i *repogen.ConflictParticipant) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.ConflictParticipant) any { return &i.UpdatedAt },
}
