...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListContractField", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListContractField", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.ContractField) any
		...
		var items []repogen.ContractField
		for rows.Next() {
			var i repogen.ContractField
		...
		return types.ListResponse{
			ContractField: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.ContractField) any{

	"id": func(i *repogen.ContractField) any { return &i.ID },

	"assertion_uuid": func(i *repogen.ContractField) any { return &i.AssertionUUID },

	"contract_uuid": func(i *repogen.ContractField) any { return &i.ContractUUID },

	"path": func(i *repogen.ContractField) any { return &i.Path },

	"path_snake": func(i *repogen.ContractField) any { return &i.PathSnake },

	"type": func(i *repogen.ContractField) any { return &i.Type },

	"required": func(i *repogen.ContractField) any { return &i.Required },

	"nullable": func(i *repogen.ContractField) any { return &i.Nullable },

	"direction": func(i *repogen.ContractField) any { return &i.Direction },

	"created_at": func(i *repogen.ContractField) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.ContractField) any { return &i.UpdatedAt },
}
