...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListAccount", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListAccount", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Account) any
		...
		var items []repogen.Account
		for rows.Next() {
			var i repogen.Account
		...
		return types.ListResponse{
			Account:     mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Account) any{

	"id": func(i *repogen.Account) any { return &i.ID },

	"key": func(i *repogen.Account) any { return &i.Key },

	"display_name": func(i *repogen.Account) any { return &i.DisplayName },

	"token_hash": func(i *repogen.Account) any { return &i.TokenHash },

	"identity_provider": func(i *repogen.Account) any { return &i.IdentityProvider },

	"identity_subject": func(i *repogen.Account) any { return &i.IdentitySubject },

	"identity_handle": func(i *repogen.Account) any { return &i.IdentityHandle },

	"email": func(i *repogen.Account) any { return &i.Email },

	"claimed_at": func(i *repogen.Account) any { return &i.ClaimedAt },

	"status": func(i *repogen.Account) any { return &i.Status },

	"last_seen_at": func(i *repogen.Account) any { return &i.LastSeenAt },

	"created_at": func(i *repogen.Account) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Account) any { return &i.UpdatedAt },
}
