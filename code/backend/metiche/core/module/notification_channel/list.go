...
func (m *module) List(ctx context.Context,
	...
	query, args, err := m.repository.BuildListEntityQuery(
		ctx,
		reqPlusOne,
		main_entity.NotificationChannel{},
		false)
	if err != nil {
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListNotificationChannel", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListNotificationChannel", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.NotificationChannel) any
		...
		var items []repogen.NotificationChannel
		for rows.Next() {
			var i repogen.NotificationChannel
		...
		return types.ListResponse{
			NotificationChannel: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.NotificationChannel) any{

	"id": func(i *repogen.NotificationChannel) any { return &i.ID },

	"team_uuid": func(i *repogen.NotificationChannel) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.NotificationChannel) any { return &i.ProjectUUID },

	"key": func(i *repogen.NotificationChannel) any { return &i.Key },

	"kind": func(i *repogen.NotificationChannel) any { return &i.Kind },

	"label": func(i *repogen.NotificationChannel) any { return &i.Label },

	"target_url": func(i *repogen.NotificationChannel) any { return &i.TargetURL },

	"min_severity": func(i *repogen.NotificationChannel) any { return &i.MinSeverity },

	"notify_human_requests": func(i *repogen.NotificationChannel) any { return &i.NotifyHumanRequests },

	"status": func(i *repogen.NotificationChannel) any { return &i.Status },

	"delivery_status": func(i *repogen.NotificationChannel) any { return &i.DeliveryStatus },

	"consecutive_failures": func(i *repogen.NotificationChannel) any { return &i.ConsecutiveFailures },

	"last_attempt_at": func(i *repogen.NotificationChannel) any { return &i.LastAttemptAt },

	"last_success_at": func(i *repogen.NotificationChannel) any { return &i.LastSuccessAt },

	"last_error": func(i *repogen.NotificationChannel) any { return &i.LastError },

	"created_by_member_uuid": func(i *repogen.NotificationChannel) any { return &i.CreatedByMemberUUID },

	"created_at": func(i *repogen.NotificationChannel) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.NotificationChannel) any { return &i.UpdatedAt },
}
