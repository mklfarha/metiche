...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListIntent", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListIntent", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Intent) any
		...
		var items []repogen.Intent
		for rows.Next() {
			var i repogen.Intent
		...
		return types.ListResponse{
			Intent:      mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Intent) any{
	...
	"id": func(i *repogen.Intent) any { return &i.ID },

	"team_uuid": func(i *repogen.Intent) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.Intent) any { return &i.ProjectUUID },

	"session_uuid": func(i *repogen.Intent) any { return &i.SessionUUID },

	"member_uuid": func(i *repogen.Intent) any { return &i.MemberUUID },

	"key": func(i *repogen.Intent) any { return &i.Key },

	"summary": func(i *repogen.Intent) any { return &i.Summary },

	"detail": func(i *repogen.Intent) any { return &i.Detail },

	"kind": func(i *repogen.Intent) any { return &i.Kind },

	"status": func(i *repogen.Intent) any { return &i.Status },

	"external_ref": func(i *repogen.Intent) any { return &i.ExternalRef },

	"revision": func(i *repogen.Intent) any { return &i.Revision },

	"declared_at": func(i *repogen.Intent) any { return &i.DeclaredAt },

	"started_at": func(i *repogen.Intent) any { return &i.StartedAt },

	"ended_at": func(i *repogen.Intent) any { return &i.EndedAt },

	"expires_at": func(i *repogen.Intent) any { return &i.ExpiresAt },
