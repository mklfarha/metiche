...
type Module interface {
	FetchDecisionTokenByID(ctx context.Context, req types.FetchDecisionTokenByIDRequest, opts ...Option) (types.FetchDecisionTokenByIDResponse, error)
	FetchDecisionTokenByTeamUUIDAndToken(ctx context.Context, req types.FetchDecisionTokenByTeamUUIDAndTokenRequest, opts ...Option) (types.FetchDecisionTokenByTeamUUIDAndTokenResponse, error)
