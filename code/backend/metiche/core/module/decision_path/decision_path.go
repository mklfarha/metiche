...
type Module interface {
	FetchDecisionPathByID(ctx context.Context, req types.FetchDecisionPathByIDRequest, opts ...Option) (types.FetchDecisionPathByIDResponse, error)
	FetchDecisionPathByTeamUUIDAndPrefix(ctx context.Context, req types.FetchDecisionPathByTeamUUIDAndPrefixRequest, opts ...Option) (types.FetchDecisionPathByTeamUUIDAndPrefixResponse, error)
