...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListDecisionPath", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListDecisionPath", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.DecisionPath) any
		...
		var items []repogen.DecisionPath
		for rows.Next() {
			var i repogen.DecisionPath
		...
		return types.ListResponse{
			DecisionPath: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.DecisionPath) any{

	"id": func(i *repogen.DecisionPath) any { return &i.ID },

	"decision_uuid": func(i *repogen.DecisionPath) any { return &i.DecisionUUID },

	"team_uuid": func(i *repogen.DecisionPath) any { return &i.TeamUUID },

	"project_uuid": func(i *repogen.DecisionPath) any { return &i.ProjectUUID },

	"pattern": func(i *repogen.DecisionPath) any { return &i.Pattern },

	"pattern_norm": func(i *repogen.DecisionPath) any { return &i.PatternNorm },

	"kind": func(i *repogen.DecisionPath) any { return &i.Kind },

	"prefix": func(i *repogen.DecisionPath) any { return &i.Prefix },

	"depth": func(i *repogen.DecisionPath) any { return &i.Depth },

	"created_at": func(i *repogen.DecisionPath) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.DecisionPath) any { return &i.UpdatedAt },
}
