...
type Module interface {
	FetchProjectByID(ctx context.Context, req types.FetchProjectByIDRequest, opts ...Option) (types.FetchProjectByIDResponse, error)
	FetchProjectByTeamUUIDAndKey(ctx context.Context, req types.FetchProjectByTeamUUIDAndKeyRequest, opts ...Option) (types.FetchProjectByTeamUUIDAndKeyResponse, error)
