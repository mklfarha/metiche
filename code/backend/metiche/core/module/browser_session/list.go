...
func (m *module) List(ctx context.Context,
	...
	// cache hit to do it.
	cacheKey := list.CacheKey("ListBrowserSession", query, args)
	if !skipShared {
	...
	runList := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListBrowserSession", zap.String("query", query), zap.Int("args", len(args)), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.BrowserSession) any
		...
		var items []repogen.BrowserSession
		for rows.Next() {
			var i repogen.BrowserSession
		...
		return types.ListResponse{
			BrowserSession: mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.BrowserSession) any{

	"id": func(i *repogen.BrowserSession) any { return &i.ID },

	"key": func(i *repogen.BrowserSession) any { return &i.Key },

	"account_uuid": func(i *repogen.BrowserSession) any { return &i.AccountUUID },

	"secret_hash": func(i *repogen.BrowserSession) any { return &i.SecretHash },

	"auth_method": func(i *repogen.BrowserSession) any { return &i.AuthMethod },

	"created_from_agent_uuid": func(i *repogen.BrowserSession) any { return &i.CreatedFromAgentUUID },

	"user_agent": func(i *repogen.BrowserSession) any { return &i.UserAgent },

	"ip_hint": func(i *repogen.BrowserSession) any { return &i.IpHint },

	"expires_at": func(i *repogen.BrowserSession) any { return &i.ExpiresAt },

	"last_seen_at": func(i *repogen.BrowserSession) any { return &i.LastSeenAt },

	"revoked_at": func(i *repogen.BrowserSession) any { return &i.RevokedAt },

	"end_reason": func(i *repogen.BrowserSession) any { return &i.EndReason },

	"created_at": func(i *repogen.BrowserSession) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.BrowserSession) any { return &i.UpdatedAt },
}
